<?php
	...
	*/
	...
	// 웹 사이트의 skin URL
	$skin_home = $site_home."/skin";
	// 웹 사이트의 게시판 skin URL
	$bbs_skin_home = $skin_home."/board";
	$member_skin_home = $skin_home."/member";

	$front_css_url = $site_home.'/assets/frontend/layout/css';
	$front_js_url = $site_home.'/assets/frontend/layout/scripts';
