...
/**
 * PHPExcel_level_Best_Fit
 *
 * @category   PHPExcel
 * @package    PHPExcel_Shared_Trend
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_level_Best_Fit extends PHPExcel_Best_Fit
{
	/**
	 ...
	 * @param	 boolean	$const
	 */
	private function _level_regression($yValues, $xValues, $const) {
	...
	function __construct($yValues, $xValues=array(), $const=True) {
		if (parent::__construct($yValues, $xValues) !== False) {
			$this->_level_regression($yValues, $xValues, $const);
		}
