    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo $default['de_root_index_use'] ? G5_URL : G5_SHOP_URL; ?>/">
                    ...
                    <li>
                        <form name="frmsearch1" action="<?php echo G5_SHOP_URL; ?>/search.php" onsubmit="return search_submit(this);">
                            ...
                            <div class="form-group top-margin10">
                                <div class="input-group search-form-div">
                                    <input type="text" name="q" value="<?php echo stripslashes(get_text(get_search_string($q))); ?>" id="sch_str" required  class="form-control" placeholder="Search">
...
<div id="wrapper" class="container">
    ...
    <div class="col-md-3">
        <?php echo outlogin('shop_basic.bootstrap'); // 아웃로그인 ?>
