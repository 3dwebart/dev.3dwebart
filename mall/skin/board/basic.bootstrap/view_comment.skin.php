...
<!-- 댓글 시작 { -->
<section>
	<h2 class="note note-success">댓글목록</h2>
	<?php
	$cmt_amt = count($list);
	for ($i=0; $i<$cmt_amt; $i++) {
	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
		<header style="z-index:<?php echo $cmt_sv; ?>">
			<h4 class="note dark" style="border-bottom: 1px solid #DEDEDE;"><?php echo get_text($list[$i]['wr_name']); ?>님의 댓글</h4>
...
<aside id="bo_vc_w">
	...
	<?php if ($is_guest) { ?>
	<div class="alert alert-success col-md-1">
	...
	<div id="bo_vc_send_sns" class="alert alert-default col-md-11"></div>
	<div class="clearfix"></div>
	<?php
		}
	?>
	...
	<div class="col-md-12 text-center visible-lg visible-md top-margin20">
		<input type="submit" id="btn_submit" class="btn blue" value="댓글등록">
	</div>

	<div class=" visible-sm visible-xs top-margin20">
		<input type="submit" id="btn_submit" class="btn blue btn-block" value="댓글등록">
	</div>
	<div class="clearfix"></div>
	</form>
</aside>
