...
<!-- 로그인 후 외부로그인 시작 -->
<section class="col-md-12 box top-bottom-padding10 bottom-margin5">
    <header>
        <h2 class="sound_only">나의 회원정보</h2>
        <div>
        <strong><?php echo $nick; ?>님</strong>
        </div>
        <?php if ($is_admin == 'super' || $is_auth) { ?><a href="<?php echo G5_ADMIN_URL; ?>/shop_admin" class="btn red form-control">관리자 모드</a><?php } ?>
    </header>
    ...
    <footer class="col-md-12 text-center">
        ...
        <a href="<?php echo G5_BBS_URL; ?>/logout.php?url=shop" class="btn red">로그아웃</a>
    </footer>
</section>
