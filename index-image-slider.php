			...
			<div class="fullwidthabnner">
				<ul id="revolutionul">
					...
					<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="../../assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
						...
						<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/bg9.jpg" alt="">
						...
						<div class="caption lfb"
							...
							data-start="1000" 
							data-easing="easeOutExpo">
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/lady.png" alt="Image 1">
						</div>
					</li>    
					<!-- THE FIRST SLIDE -->
					<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="../../assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
						<!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
						<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/bg1.jpg" alt="">
						...
						<div class="caption lfb"
							...
							data-start="1000" 
							data-easing="easeOutExpo">
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/man-winner.png" alt="Image 1">
						</div>
					</li>
					<!-- THE SECOND SLIDE -->
					<li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="9400" data-thumb="../../assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
						<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/bg2.jpg" alt="">
						...
						<div class="caption lfr slide_item_right" 
							...
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/mac.png" alt="Image 1">
						</div>
						<div class="caption lfr slide_item_right" 
							data-x="580" 
							data-y="245" 
							...
							data-start="2000" 
							data-easing="easeOutBack">
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/ipad.png" alt="Image 1">
						</div>
						<div class="caption lfr slide_item_right" 
							data-x="735" 
							data-y="290" 
							...
							data-start="2500" 
							data-easing="easeOutBack">
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/iphone.png" alt="Image 1">
						</div>
						<div class="caption lfr slide_item_right" 
							data-x="835" 
							data-y="230" 
							...
							data-start="3000" 
							data-easing="easeOutBack">
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/macbook.png" alt="Image 1">
						</div>
						<div class="caption lft slide_item_right" 
							...
							data-start="5000" 
							data-easing="easeOutBack">
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/hint1-red.png" id="rev-hint1" alt="Image 1">
						</div>
						<div class="caption lfb slide_item_right" 
							...
							data-start="5500" 
							data-easing="easeOutBack">
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/hint2-red.png" id="rev-hint2" alt="Image 1">
						</div>
					</li>
					<!-- THE THIRD SLIDE -->
					<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="../../assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
						<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/bg3.jpg" alt="">
					...
					<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="../../assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
						<!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
						<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/bg4.jpg" alt="">                        
						...
						<a class="caption lft slide_btn btn red slide_item_left" href="http://www.keenthemes.com/preview/index.php?theme=metronic_admin" 
							target="_blank" 
							data-x="30"
							data-y="300"
							data-speed="400"
						...
						<div class="caption lft start"  
							...
							data-start="2000" 
							data-easing="easeOutBack"  >
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/iphone_left.png" alt="Image 2">
						</div>
						<div class="caption lft start"  
							data-x="850" 
							data-y="55" 
							...
							data-start="2400" 
							data-easing="easeOutBack">
							<img src="<?php echo($site_home); ?>/assets/frontend/pages/img/revolutionslider/iphone_right.png" alt="Image 3">
						</div>
					</li>
				</ul>
