...
<?
    ...
    $sql_tmpl = "SELECT writer, email, content
                 FROM bbs_comments WHERE id=%d";
    $result = $db -> query($sql_tmpl, array($comment_id));
    ...
    <fieldset>
        ...
        <div class='form-group form-inline'>
            ...
            <div class="form-group">
                <input type="text" name="writer" class="form-control"
                    placeholder='작성자' value="<?=$comments['writer']?>"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="email" name="email" class="form-control"
                    placeholder='이메일' value="<?=$comments['email']?>"/>
            </div>
            <? } ?>
        ...
        <div class='form-group'>
            <textarea class="form-control"
                name='content'><?=$comments['content']?></textarea>
        </div>
    </fieldset>
</form>
