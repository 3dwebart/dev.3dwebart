	...
	<script>
		$(function() {
			...
			<div class="page-header">
				<h1>게시판 그룹 정보 수정(<?=$row['bo_group_name']?>)</h1>
			</div>
			<!-- 정보 수정 폼 시작 -->
			<form name="myform" id="myform" class="myform" method="post" action="<?=$admin_home?>/adm_group_edit_ok.php" role="form"  enctype="multipart/form-data">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-10 alert alert-default">
							<input type="hidden" name="bo_group_id" id="bo_group_id" value="<?=$row['bo_group_id']?>" class="form-control">
							<?=$row['bo_group_id']?>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-10 alert alert-default">
							<input type="text" name="bo_group_name" id="bo_group_name" value="<?=$row['bo_group_name']?>" class="form-control">
						</div>
					</div>
