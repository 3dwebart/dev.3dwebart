	...
	<script>
		$(function() {
			...
			$('edit-btn').click(function() {
				...
				$('.MyFrom').attr('action', '<?=$admin_home?>/adm_admin_edit_ok.php');
				$('.MyFrom').submit();
			});
		});
	</script>
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<fieldset>
				...
				<input type="hidden" name="adm_id" id="adm_id" value="<?=$row['adm_id']?>">
				<div class="row">
				...
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-10 alert alert-default">
							<p class="form-control-static"><?=$row['adm_id']?></p>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-10 alert alert-default">
							<input type="text" name="adm_name" id="adm_name" class="form-control" value="<?=$row['adm_name']?>">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-10 alert alert-default">
							<input type="text" name="adm_nic" id="adm_nic" class="form-control" value="<?=$row['adm_nic']?>">
						</div>
					</div>
				</div>
				<div class="row">
