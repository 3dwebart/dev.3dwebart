		...
		<div class="page-content">
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-10 alert alert-default">
						<select name="user_level" id="user_level" class="form-control">
							<option value="1" <? if ($row['user_level'] == 1) { ?>selected<?}?>>레벨 1</option>
							<option value="2" <? if ($row['user_level'] == 2) { ?>selected<?}?>>레벨 2</option>
							<option value="3" <? if ($row['user_level'] == 3) { ?>selected<?}?>>레벨 3</option>
							<option value="4" <? if ($row['user_level'] == 4) { ?>selected<?}?>>레벨 4</option>
							<option value="5" <? if ($row['user_level'] == 5) { ?>selected<?}?>>레벨 5</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-10 alert alert-default">
						<input type="text" name="new_user_pw" id="new_user_pw" class="form-control" placeholder="아이디" value="<?=$row['user_id']?>" disabled="">
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-2 alert alert-success">
				...
				<div class="form-group">
					...
					<div class="col-md-10 alert alert-default">
						<input type="text" name="tel" id="tel" class="form-control" value="<?=$row['reg_date']?>" disabled="" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-2 alert alert-success">
					...
					<div class="col-md-10 alert alert-default">
						<input type="text" name="tel" id="tel" class="form-control" value="<?=$row['edit_date']?>" disabled="" />
					</div>
				</div>
