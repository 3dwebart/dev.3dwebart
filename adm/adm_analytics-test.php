<?php
    ...
    $client_id = '390342849761-c9jlb96h7j1iup50c6kkgqm04h49jt90.apps.googleusercontent.com';
    
    // From the APIs console
    $client_secret = 'fNsTJG7DiJxczF9hnZkoSDlo';
    
     // Url to your this page, must match the one in the APIs console
    $redirect_uri = 'http://www.3dwebart.com';

    // Analytics account id like, 'ga:xxxxxxx'
    $account_id = '3dwebart';
    
    session_start();
    include('../include/GoogleAnalyticsAPI.class.php');
