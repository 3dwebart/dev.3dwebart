<?php
include $_SERVER['DOCUMENT_ROOT']."/Classes/PHPExcel/Classes/PHPExcel.php";
include $_SERVER['DOCUMENT_ROOT']."/Classes/PHPExcel/Classes/PHPExcel/IOFactory.php";

$objPHPExcel = new PHPExcel();
// 엑셀 데이터를 담을 배열을 선언한다.
$allData = array();
// 파일의 저장형식이 utf-8일 경우 한글파일 이름은 깨지므로 euc-kr로 변환해준다.
$file = $_SERVER['DOCUMENT_ROOT'].'/test/제목 없는 스프레드시트.xlsx';
//$filename = iconv("UTF-8", "EUC-KR", $_FILES['excelFile']['name']);
$filename = $file;//iconv("UTF-8", "EUC-KR", $file);
