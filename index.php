<?php include_once('header_ui.php'); ?>
		...
		<!-- END SLIDER -->
		<div class="main">
			<div class="index-box index-maya">
				<h1 class="title">3D Maya</h1>
				<div class="col-md-3 col-sm-6 img-block">
					<img src="img/maya-tmp1.jpg" alt="" class="img-responsive">
					<div class="mask">
				...
				<div class="col-md-3 col-sm-6 img-block">
					<img src="img/maya-tmp2.jpg" alt="" class="img-responsive">
					<div class="mask">
						<div class="mask-content">
							aaaaa
						</div>
				...
				<div class="col-md-3 col-sm-6 img-block">
					<img src="img/maya-tmp3.jpg" alt="" class="img-responsive">
					<div class="mask">
						<div class="mask-content">
							aaaaa
						</div>
				...
				<div class="col-md-3 col-sm-6 img-block">
					<img src="img/maya-tmp4.jpg" alt="" class="img-responsive">
					<div class="mask">
						<div class="mask-content">
							aaaaa
						</div>
				...
				<div class="content visible-md visible-lg">
					<p>
						마야를 이용한 제품 디자인 및 캐릭터 디자인, 인테래어 디자인을 합니다.
					</p>
				</div>
			</div>
			<div class="index-box index-web">
				<h1 class="title">WEB Develope</h1>
				...
				<div class="content visible-md visible-lg">
					<p>
						웹 디자인 밎 웹 프론트엔드, 웹 백엔드 개발을 합니다.
					</p>
				</div>
			</div>
			<div class="index-box index-photo">
				<h1 class="title">PHOTOSHOP / ILLUST</h1>
				<div class="col-md-3 col-sm-6"><img src="img/maya-tmp1.jpg" alt="" class="img-responsive"></div>
				<div class="col-md-3 col-sm-6"><img src="img/maya-tmp2.jpg" alt="" class="img-responsive"></div>
				<div class="col-md-3 col-sm-6"><img src="img/maya-tmp3.jpg" alt="" class="img-responsive"></div>
				<div class="col-md-3 col-sm-6"><img src="img/maya-tmp4.jpg" alt="" class="img-responsive"></div>
				<div class="clearfix"></div>
				<div class="content visible-md visible-lg">
					<p>
...
(function($) {
	...
	jQuery('.index-box').css('min-height', win_H);
	jQuery('.mask').width(jQuery('.img-block').width());
	jQuery('.mask').height(jQuery('.img-block img').height());
	...
	jQuery(document).on('mouseenter', '.index-maya .img-block', function() {
		jQuery(this).find('.mask').addClass('active');
	});

	jQuery(document).on('mouseleave', '.index-maya .img-block', function() {
		jQuery(this).find('.mask').removeClass('active');
	});
	/* Modal 페이지 로드시 뿌려주기
